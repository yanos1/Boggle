...
JOKES_AND_FUN_FACTS = [
    ...
    "Why was the Boggle game feeling so down?\n Because it had a 'board' depression",
    ...
    "Why did the Boggle game go to the bar?\n To get 'board' and play with the 'dice'",
    "Boggle was invented by Allan Turoff in 1972,\n and later published by Parker Brothers in 1974.",

    "The game was first called 'Lexico' and later renamed to 'Boggle' by Turoff.",
